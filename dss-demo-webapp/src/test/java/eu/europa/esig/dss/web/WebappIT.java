...
public class WebappIT {
	...
	@Test
	public void wsdlSignatureOneDoc() {
		driver.get(BASE_URL + "services/soap/signature/one-document?wsdl");
	}

	@Test
	public void wsdlSignatureMultiDocs() {
		driver.get(BASE_URL + "services/soap/signature/multiple-documents?wsdl");
	}
	...
	@Test
	public void restSignatureOneDoc() {
		driver.get(BASE_URL + "/services/rest/signature/one-document?_wadl");
	}

	@Test
	public void restSignatureMultiDocs() {
		driver.get(BASE_URL + "/services/rest/signature/multiple-documents?_wadl");
	}
